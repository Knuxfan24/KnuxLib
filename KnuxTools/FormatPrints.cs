namespace KnuxTools
{
    public class FormatPrints
    {
        ...
        public static void Hedgehog()
        {
            ...
            Console.WriteLine("Sector Visibility Collision (.svcol.bin/.svcol)");
            Helpers.ColourConsole("    Version Flag (Sonic Lost World (Wii U)) - sonic2013_cafe", true, ConsoleColor.Yellow);
            Helpers.ColourConsole("    Version Flag (Sonic Lost World) - sonic2013", true, ConsoleColor.Yellow);
            Helpers.ColourConsole("    Version Flag (Sonic Forces) - wars", true, ConsoleColor.Yellow);
            Helpers.ColourConsole("    Version Flag (Sonic X Shadow Generations) - miller", true, ConsoleColor.Yellow);
        ...
        public static void SonicStorybook()
        {
            ...
            Console.WriteLine("Path Spline (.pth)");
            Helpers.ColourConsole("    Version Flag (Sonic and the Secret Rings) - storybook_pathspline_sr", true, ConsoleColor.Yellow);
            Helpers.ColourConsole("    Version Flag (Sonic and the Black Knight) - storybook_pathspline_bk", true, ConsoleColor.Yellow);
