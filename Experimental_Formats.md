...
- [Path Spline (Wars) (.path)](KnuxLib/Engines/Hedgehog/PathSpline_Wars.cs). Reads almost the whole format (although the k-d tree is a bit of a mystery), but doesn't have any saving, exporting or importing.
